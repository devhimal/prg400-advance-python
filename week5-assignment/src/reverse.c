...
#define __PYX_HAVE__reverse
#define __PYX_HAVE_API__reverse
/* Early includes */
#include <string.h>
#include <stdlib.h>
#ifdef _OPENMP
...
/* Module declarations from "reverse" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "reverse"
extern int __pyx_module_is_main_reverse;
int __pyx_module_is_main_reverse = 0;

/* Implementation of "reverse" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_7reverse_reverse_string(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_s); /* proto */
...
#define __pyx_kp_u_reverse_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_encode __pyx_string_tab[6]
...
#define __pyx_n_u_length __pyx_string_tab[11]
...
#define __pyx_n_u_original __pyx_string_tab[15]
#define __pyx_n_u_pop __pyx_string_tab[16]
#define __pyx_n_u_py_bytes __pyx_string_tab[17]
#define __pyx_n_u_py_str __pyx_string_tab[18]
#define __pyx_n_u_qualname __pyx_string_tab[19]
#define __pyx_n_u_reverse __pyx_string_tab[20]
#define __pyx_n_u_reverse_string __pyx_string_tab[21]
#define __pyx_n_u_reversed_str __pyx_string_tab[22]
...
#define __pyx_kp_b_iso88591_7_1_fAQ_gV1G2Q_U_1_AU_7_Bb_1_1 __pyx_string_tab[28]
...
/* Python wrapper */
static PyObject *__pyx_pw_7reverse_1reverse_string(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_7reverse_1reverse_string = {"reverse_string", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_7reverse_1reverse_string, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7reverse_1reverse_string(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "reverse_string", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("reverse_string", 1, 1, 1, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("reverse_string", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("reverse.reverse_string", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7reverse_reverse_string(__pyx_self, __pyx_v_s);
...
static PyObject *__pyx_pf_7reverse_reverse_string(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_s) {
  PyObject *__pyx_v_py_bytes = 0;
  char *__pyx_v_original;
  int __pyx_v_length;
  char *__pyx_v_reversed_str;
  int __pyx_v_i;
...
*/
  ...
  if (!(likely(PyBytes_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None) || __Pyx_RaiseUnexpectedTypeError("bytes", __pyx_t_1))) __PYX_ERR(0, 5, __pyx_L1_error)
...
*/
  ...
  __pyx_t_4 = __Pyx_PyBytes_AsWritableString(__pyx_v_py_bytes); if (unlikely((!__pyx_t_4) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_v_original = __pyx_t_4;
 ...
 *     cdef int i
*/
  __pyx_v_length = strlen(__pyx_v_original);
 ...
 * 
*/
  __pyx_v_reversed_str = ((char *)malloc((__pyx_v_length + 1)));
 ...
 * 
*/
    (__pyx_v_reversed_str[__pyx_v_i]) = (__pyx_v_original[((__pyx_v_length - 1) - __pyx_v_i)]);
  }
...
*/
  (__pyx_v_reversed_str[__pyx_v_length]) = '\x00';
 ...
 *     return py_str
*/
  __pyx_t_8 = __Pyx_ssize_strlen(__pyx_v_reversed_str); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_t_1 = __Pyx_decode_c_string(__pyx_v_reversed_str, 0, __pyx_t_8, NULL, NULL, PyUnicode_DecodeUTF8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "reverse" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_reverse", 0);
  ...
  if (__pyx_module_is_main_reverse) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "reverse")) {
      if (unlikely((PyDict_SetItemString(modules, "reverse", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef char* original = py_bytes
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_7reverse_1reverse_string, 0, __pyx_mstate_global->__pyx_n_u_reverse_string, NULL, __pyx_mstate_global->__pyx_n_u_reverse, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_reverse_string, __pyx_t_2) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init reverse", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init reverse");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{11},{5},{20},{18},{18},{6},{8},{1},{13},{5},{6},{8},{10},{8},{8},{3},{8},{6},{12},{7},{14},{12},{1},{12},{10},{8},{6},{108}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 